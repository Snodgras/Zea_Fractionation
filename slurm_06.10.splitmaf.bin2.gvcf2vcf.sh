...
-V ready_Sb313_TdKS_Chr10.bin2.gvcf.gz.recode.vcf \
-V ready_Sb313_ZdGigi_4to1_Chr10.bin2.gvcf.gz.recode.vcf \
-V ready_Sb313_ZdMomo_4to1_Chr10.bin2.gvcf.gz.recode.vcf \
...
--batch-size 1 \
--genomicsdb-workspace-path chr10.bin2.noZn_gatkDBimport \
-L 10 \
...
-R $ref \
-V gendb://chr10.bin2.noZn_gatkDBimport \
