...
singularity exec --bind $PWD /work/LAS/mhufford-lab/elena/.conda/phg_latest.sif /tassel-5-standalone/run_pipeline.pl \
        -Xmx300g \
        -MAFToGVCFPlugin \
        -referenceFasta /work/LAS/mhufford-lab/snodgras/Fractionation/assemblies_final/Zv-TIL01-REFERENCE-PanAnd-1.0.fasta \
        -mafFile Sb313_ZvTIL01_anchorwave.swap.maf \
        -sampleName Sb313_ZvTIL01 \
        -gvcfOutput Sb313_ZvTIL01_anchorwave.swap.gvcf \
        -fillGaps true > ZvTIL01.out_gvcf.log 2>&1
